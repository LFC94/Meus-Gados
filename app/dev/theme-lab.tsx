...
export default function ThemeLabScreen() {
  ...
  const tileStyles = useMemo(() => {
    ...
    return {
      light: build("light"),
      dark: build("dark"),
    } as Record<ColorScheme, ReturnType<typeof build>>;
  }, []);
      ...
      <ScrollView className="flex-1">
        <View className="gap-4 pb-8">
            ...
            {(["light", "dark"] as ColorScheme[]).map((scheme) => (
              <Pressable
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      colorScheme === scheme ? tileStyles[scheme].activeBackground : tileStyles[scheme].background,
                    borderColor:
                      colorScheme === scheme ? tileStyles[scheme].activeBackground : tileStyles[scheme].border,
                  },
                ]}
                onPress={() => {
              ...
              >
                <Text
                  style={[
                    ...
                    {
                      color: colorScheme === scheme ? tileStyles[scheme].activeText : tileStyles[scheme].text,
                    },
                  ]}
                >
                ...
                <Text
                  style={[
                    ...
                    {
                      color: colorScheme === scheme ? tileStyles[scheme].activeText : tileStyles[scheme].subText,
                    },
                  ]}
                >
          ...
          <ThemedView className="rounded-2xl border border-border p-4">
            ...
            <Text className="mt-1 text-sm text-muted">Buttons and badges driven by global {colorScheme} palette</Text>
